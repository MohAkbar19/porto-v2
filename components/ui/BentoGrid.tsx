  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundImage: id === 4 ? "url('/bg.jpg')" : "none",
    ...
    >
      {header}
      <div
        className={`group-hover/bento:translate-x-2 transition duration-200 ${stylemain}`}
      >
        {icon}
        ...
        <div className={`${style2}`}>
          <div
            className={`font-sans font-bold text-2xl text-neutral-600 dark:text-neutral-200 mt-2 ${
              id === 4 ? "mt-32" : ""
            }`}
          >
            {title}
          ...
          <div
            ...
            } ${id === 1 ? "mt-5" : " *:"} mb-10 font-sans font-normal text-neutral-600 text-[15px] dark:text-neutral-300`}
          >
            {description}
          </div>
